nv.models.multiChart = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      //yScale2 .domain(d3.extent(d3.extent(d3.merge(series1).concat(extraValue2), function(d) { return d.y } ).concat(lines2.forceY())))
      //yScale2 .domain(d3.extent(d3.extent(d3.merge(series1).concat(extraValue2), function(d) { return d.y } ).concat(bars2.forceY())))
              .range([0, availableHeight])
